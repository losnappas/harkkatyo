...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_medium_editor__ = __webpack_require__(46);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        axios.get('/courses/' + this.courseid + '/tasks').then(function (response) {
    ...
    methods: {
        ...
        checkAnswer2: function checkAnswer2(answer) {
            var _this2 = this;
            ...
            axios.get('/tiko/answer/' + this.tasks[this.current].id).then(function (response) {
                ...
                return console.error('in error: ', error);
            });
        },
...
Component.options.__file = "C:\\Users\\lmaogg\\Desktop\\lkst\\laravel\\harkkatyo52\\resources\\assets\\js\\components\\CustomEditor.vue"
...
Component.options.__file = "C:\\Users\\lmaogg\\Desktop\\lkst\\laravel\\harkkatyo52\\resources\\assets\\js\\components\\TaskList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
